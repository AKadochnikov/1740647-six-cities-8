...
function Main ({displayStyle, tabIndex, spanWidth80, spanWidth100}: HeaderProps): JSX.Element {
  return (<>
            ...
            <section className="cities__places places">
              ...
              <form className="places__sorting" action="#" method="get">
                ...
                <ul className="places__options places__options--custom places__options--opened">
                  <li className="places__option places__option--active" tabIndex={tabIndex}>Popular</li>
                  <li className="places__option" tabIndex={tabIndex}>Price: low to high</li>
                  <li className="places__option" tabIndex={tabIndex}>Price: high to low</li>
                  <li className="places__option" tabIndex={tabIndex}>Top rated first</li>
                </ul>
              </form>
